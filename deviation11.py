...
<style>
    ...
    :root {
        ...
        --info: #3ABFF8;
        --sidebar-bg: #2A4172;
        --sidebar-item-bg: #3D5393;
        --sidebar-item-hover: #314279;
        --sidebar-text: #E6EAF5;
    }
    ...
    /* Radio buttons in sidebar - fond plus clair */
    .stRadio > div {
    ...
    /* Amélioration de la lisibilité des éléments dans la sidebar */
    [data-testid="stSidebar"] .stCheckbox label {
        color: var(--sidebar-text) !important;
        font-weight: 500;
    }
    
    [data-testid="stSidebar"] span[data-baseweb="checkbox"] span {
    ...
    /* Amélioration de la lisibilité du statut du modèle */
    .model-status-box {
        display: flex;
        align-items: center;
        margin-bottom: 1.5rem;
    ...
    /* Séparateurs dans la sidebar plus visibles */
...
with st.sidebar:
    ...
    <div class="author-signature" style="margin-bottom: 1.5rem;">
        ...
        <div class="author-details">
            ...
            <div class="author-title-small" style="color: #E6EAF5;">Géologue & Data Scientist</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
